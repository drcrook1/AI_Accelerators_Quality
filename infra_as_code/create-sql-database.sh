...
SQL_SKU=${SQL_SKU:-S1}
SQL_ADMIN_USER=${SQL_ADMIN_NAME:-serveradmin}
...
az storage file upload-batch --source sql_creation \
...
echo ". temporary container instance: $instanceName"
